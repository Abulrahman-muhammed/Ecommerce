                    ...
                    <div class="slider-head">
                        ...
                        <div class="hero-slider">
                            ...
                            <div class="single-slider"
                                style="background-image: url(front-assets/images/hero/slider-bg1.jpg);">
                                <div class="content">
                                    ...
                                    <div class="button">
                                        <a href="{{ route('front.products.index') }}" class="btn">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                            <!-- End Single Slider -->
                            <!-- Start Single Slider -->
                            <div class="single-slider"
                                style="background-image: url(front-assets/images/hero/slider-bg2.jpg);">
                                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12 md-custom-padding">
                            ...
                            <div class="hero-small-banner"
                                style="background-image: url('front-assets/images/hero/small-banner1.jpg');">
                                <div class="content">
                                    <h2>
                        ...
                        <div class="col-lg-12 col-md-6 col-12">
                            ...
                            <div class="hero-small-banner style2">
                                <div class="content">
                                    ...
                                    <div class="button">
                                        <a class="btn" href="{{ route('front.products.index') }}">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Start Small Banner -->
    ...
    <section class="featured-categories section">
        <div class="container">
            ...
            <div class="row">
                @forelse ($featuredCategories as $category)
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="single-category">
                            ...
                            <div class="images">
                                <img 
                                    src="{{ $category->image_url ?? 'https://placehold.co/180x180' }}" 
                                    alt="{{ $category->name }}">
                            </div>
                        </div>
                    </div>
                @empty
                    <div class="col-12">
                        <p class="text-center">No featured categories found.</p>
                    </div>
                @endforelse
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner" style="background-image:url('https://www.freepik.com/free-photos-vectors/ecommerce-slider')">
                        <div class="content">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner custom-responsive-margin"
                        style="background-image:url('https://www.freepik.com/free-photos-vectors/ecommerce-slider');">
                        <div class="content">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-12">
                    ...
                    <div class="single-banner right"
                        style="background-image:url('https://www.freepik.com/free-photos-vectors/ecommerce-slider');margin-top: 30px;">
                        <div class="content">
