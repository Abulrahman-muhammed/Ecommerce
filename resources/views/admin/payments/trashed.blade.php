...
@section('title', 'Trashed Payments')
...
.table-header { display:flex; align-items:center; justify-content:space-between; padding:1rem 1.5rem; border-bottom:1px solid rgba(75,70,92,.07); }
.table-header-title { font-size:.9375rem; font-weight:600; color:#4b465c; }
.table-count-badge {
    display:inline-flex; align-items:center;
    background:rgba(234,84,85,.1); color:#ea5455;
    border-radius:50px; font-size:.6875rem; font-weight:700; padding:2px 10px; margin-left:.5rem;
}
...
.empty-icon { width:64px; height:64px; border-radius:.5rem; background:rgba(234,84,85,.08); display:flex; align-items:center; justify-content:center; margin:0 auto 1rem; font-size:1.75rem; color:#ea5455; }
...
.pagi-wrap .pagination .page-link:hover { background:rgba(234,84,85,.08); border-color:#ea5455; color:#ea5455; }
.pagi-wrap .pagination .page-item.active .page-link { background:#ea5455; border-color:#ea5455; color:#fff; box-shadow:0 2px 8px rgba(234,84,85,.4); }
...
<div class="container-xxl flex-grow-1 container-p-y payments-page">
    ...
    <div class="page-header-card">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div>
                <h4 class="page-title">
                    <i class="ri ri-delete-bin-5-line me-2"></i>Trashed Payments
                </h4>
                ...
                <div class="d-flex gap-2 mt-1">
                    <span class="stat-chip">
                        ...
                        Trashed: <strong>{{ $payments->total() }}</strong>
                    </span>
                </div>
            </div>
            ...
            <table class="mat-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span style="font-weight:700;color:#4b465c;font-size:.875rem;">
                                {{ optional($payment->order)->order_number ?? '—' }}
                            </span>
                        </td>
                        <td>
                        ...
                        <td style="font-size:.875rem;font-weight:600;">
                        ...
                        <td class="center">
                            <div class="d-flex justify-content-center gap-1">
                                ...
                                <form action="{{ route('admin.payments.force-delete', $payment->id) }}"
                    ...
                    <tr>
                        <td colspan="8">
                            <div class="empty-state">
                                ...
                                <p class="empty-sub">No trashed payments found</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
    ...
    btn.addEventListener('click', function () {
        ...
        Swal.fire({
            ...
            html: `<p style="color:#a8aaae;font-size:.875rem;margin:0">
                       This payment will be <strong style="color:#ea5455">permanently deleted</strong>
