...
<div class="form-floating form-floating-outline mb-4">
  ...
  @enderror
          ...
          <img src="{{ asset('admin-assets/assets/img/illustrations/tree-3.png') }}"
               alt="auth-tree"
               class="authentication-image-object-left d-none d-lg-block" />
          <img src="{{ asset('admin-assets/assets/img/illustrations/auth-basic-mask-light.png') }}"
               class="authentication-image d-none d-lg-block scaleX-n1-rtl"
               height="172"
               alt="triangle-bg" />
          <img src="{{ asset('admin-assets/assets/img/illustrations/tree.png') }}"
               alt="auth-tree"
