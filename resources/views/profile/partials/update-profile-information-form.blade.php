...
<div class="container-xxl flex-grow-1 container-p-y profile-page">
    ...
    <div class="hero-card anim anim-1">
        <div class="hero-avatar-wrap">
            <img src="{{ $admin->image ? asset('storage/' . $admin->image) : asset('admin/img/default-avatar.png') }}"
                 alt="{{ $admin->name }}"
        ...
        <div>
            ...
            <div class="hero-chips">
                ...
                @if($admin->phone)
                <span class="hero-chip">
                    <i class="ri ri-phone-line"></i>{{ $admin->phone }}
                </span>
                @endif
                <span class="hero-chip">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="sec-card anim anim-1">
                    ...
                    <div class="sec-card-body">
                        ...
                        <div class="row g-3 mb-0">
                            <div class="col-sm-6">
                                <label class="form-label-mat">Name <span class="req">*</span></label>
                ...
                <div class="sec-card anim anim-2">
                    <div class="sec-card-header">
                        <h6 class="sec-card-title">
                            <i class="ri ri-map-pin-line"></i> Contact
                        </h6>
                    </div>
                    <div class="sec-card-body">
                        <div class="row g-3 mb-0">
                ...
                <div class="sec-card anim anim-2">
                    ...
                    <div class="sec-card-body" style="padding:.875rem 1.25rem">
                        ...
                        <div class="meta-row">
                            ...
                            <span class="meta-value">{{ $admin->updated_at->format('d M Y') }}</span>
                        </div>
                        <div class="meta-row">
...
<script>
  ...
  function handleRemoveCheck(checkbox) {
    if (checkbox.checked) {
      ...
      document.getElementById('heroAvatar').src    = '{{ asset('admin/img/default-avatar.png') }}';
    }
  }
